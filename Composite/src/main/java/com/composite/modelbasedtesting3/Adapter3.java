...
public class Adapter3 {
	...
	public void ykb() throws Exception {
		...
		String sendGet = sendGet("http://localhost:8080/Composite/rest/getComposite/getRates/bank/YKB");
		isNegativeValue(parseOutput(sendGet));
	}
	...
	public void bank1() throws Exception {
		...
		String sendGet = sendGet("http://localhost:8080/Composite/rest/getComposite/getRates/bank/1");
		isNegativeValue(parseOutput(sendGet));
	}
	...
	public void bank2() throws Exception {
		...
		String sendGet = sendGet("http://localhost:8080/Composite/rest/getComposite/getRates/bank/2");
		isNegativeValue(parseOutput(sendGet));
	}

	public void bank3() throws Exception {
		String sendGet = sendGet("http://localhost:8080/Composite/rest/getComposite/getRates/bank/3");
		isNegativeValue(parseOutput(sendGet));
	}
	...
	public void bank4() throws Exception {
		...
		String sendGet = sendGet("http://localhost:8080/Composite/rest/getComposite/getRates/bank/4");
		isNegativeValue(parseOutput(sendGet));
	}
